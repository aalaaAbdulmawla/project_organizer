...
class ProjectCommentsControllerTest < ActionController::TestCase
  ...
  test "should create project_comment" do
    assert_difference('ProjectComment.count') do
      post :create, project_comment: { comment: @project_comment.comment, creator: @project_comment.creator, project_id: @project_comment.project_id }
    end
  ...
  test "should update project_comment" do
    patch :update, id: @project_comment, project_comment: { comment: @project_comment.comment, creator: @project_comment.creator, project_id: @project_comment.project_id }
    assert_redirected_to project_comment_path(assigns(:project_comment))
  end
